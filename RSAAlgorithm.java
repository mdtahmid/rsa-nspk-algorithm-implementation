/*********************************************************************************************************************************************************
	...
	2) If the message value is above 2000 there is a chance it could cause a silent long overflow error. Using BigInteger would solve this.
	...
	5) In the real world, for any random number generation, e.g generating a random prime number, there are cryptographically secure ways
